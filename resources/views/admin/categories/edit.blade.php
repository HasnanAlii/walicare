<x-admin-layout>
    <div class="py-6 max-w-2xl mx-auto">
        ...
        {{-- Header --}}
        <h2 class="text-2xl font-bold text-green-900 mb-6">Edit Kategori: {{ $category->name }}</h2>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="flex gap-2">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-500">Perbarui</button>
