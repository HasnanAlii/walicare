<x-admin-layout>
    <div class="py-6 max-w-2xl mx-auto">
        ...
        {{-- Header --}}
        <h2 class="text-2xl font-bold text-green-900 mb-6">Tambah Tonggak Program Baru</h2>
        ...
        {{-- Form --}}
        <form action="{{ route('admin.milestones.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="3" 
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="mb-4 flex items-center gap-2">
                <input type="checkbox" name="is_reached" id="is_reached" value="1" {{ old('is_reached') ? 'checked' : '' }} class="h-4 w-4 text-green-600">
            ...
            <div class="flex justify-end gap-2 mt-6">
                ...
                <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-500 transition">Simpan</button>
            </div>
        </form>
